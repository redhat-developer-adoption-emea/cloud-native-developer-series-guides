...
`{{COOLSTORE_PROJECT}}-{{OPENSHIFT_USER}}` project.

~~~shell
$ oc project {{COOLSTORE_PROJECT}}-{{OPENSHIFT_USER}}
~~~
...
Go OpenShift Web Console inside the **{{COOLSTORE_PROJECT}}-{{OPENSHIFT_USER}}** project and from the left sidebar 
