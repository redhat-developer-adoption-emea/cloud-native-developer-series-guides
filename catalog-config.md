...
> password. The `--labels` allows assigning arbitrary key-value labels to the application objects 
> in order to make it easier to find them later on when you have many applications in the same project.
